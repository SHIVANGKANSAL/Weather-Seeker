...
var api = [{
    ...
    weatherApi: function () {
            ...
            if (navigator.geolocation) {
                ...
                navigator.geolocation.getCurrentPosition(
                    ...
                    function success(position) {
                        ...
                        var APIKey = "e2dd9269be33d088f21b436da4f217f0"
                        ...
                        function displayWeatherByGeolocation() {
                            ...
                            var queryURLGeolocation = "https://api.openweathermap.org/data/2.5/weather?lat=" + latitude + "&lon=" + longitude + "&appid=" + APIKey + "&units=metric";
                        ...
                        function displayWeatherForecastByGeolocation() {
                            var queryURLGeolocationForWeatherForecase = "https://api.openweathermap.org/data/2.5/forecast?lat=" + latitude + "&lon=" + longitude + "&appid=" + APIKey + "&units=metric";
        ...
        function displayWeatherData(weather) {
            ...
            var pCurrentTemp = currentTempRound + "°C";
        ...
        function displayWeatherByCity() {
            ...
            var APIKey = "e2dd9269be33d088f21b436da4f217f0";
            var queryURLCity = "https://api.openweathermap.org/data/2.5/weather?q=" + cityName + "&appid=" + APIKey + "&units=metric";
        ...
        function displayWeatherForecastByCity() {
            ...
            var cityName = $(".location").val().trim();
            var APIKey = "e2dd9269be33d088f21b436da4f217f0";
            var queryURLCityForWeatherForecast = "https://api.openweathermap.org/data/2.5/forecast?q=" + cityName + "&appid=" + APIKey + "&units=metric";
